...
logger.showScriptOutline('Development Workflow', devWorkflowSequence, 'verbose');
...
const productionSequence = [
  ...
  },
  {
    ...
    dependencies: ['FIGMA_TOKEN', 'AIRTABLE_PERSONAL_ACCESS_TOKEN'],
  },
  {
    name: 'content-sync',
    description: 'Force refresh all content from Airtable',
    script: 'syncContent.js',
...
logger.showScriptOutline('Production Build', productionSequence, 'verbose', 'success');

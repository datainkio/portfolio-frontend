...
// generator call, not a hand-written object literal. A namespace may also
// spread the generator and extend it (`video` adds a `media` sub-namespace for
// the <video> element's own playstate); the ten lifecycle keys must still come

...
export class TextFormat {
  ...
  get fontPostScriptName() {
    return this._fontPostScriptName;
  }
  get fontWeight() {
  ...
  get textAlignHorizontal() {
    return this._textAlignHorizontal;
  }
  ...
  get lineHeightPercent() {
    return this._lineHeightPercent;
  }
  get lineHeightUnit() {
  ...
  set fontFamily(value) {
    if (typeof value !== "string")
      throw new TypeError("Font family must be a string");
    this._fontFamily = value;
  }

  set fontPostScriptName(value) {
    if (typeof value !== "string")
      throw new TypeError("Font PostScript name must be a string");
    this._fontPostScriptName = value;
  }

  set fontWeight(value) {
    if (typeof value !== "number")
      throw new TypeError("Font weight must be a number");
    this._fontWeight = value;
  }

  set fontSize(value) {
    if (typeof value !== "number")
      throw new TypeError("Font size must be a number");
  ...
  set letterSpacing(value) {
    if (typeof value !== "number")
      throw new TypeError("Letter spacing must be a number");
    this._letterSpacing = value;
  }

  set lineHeightPx(value) {
    if (typeof value !== "number")
      throw new TypeError("Line height (px) must be a number");
    this._lineHeightPx = value;
  }

  set lineHeightPercent(value) {
    if (typeof value !== "number")
      throw new TypeError("Line height (%) must be a number");

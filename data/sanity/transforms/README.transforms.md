...
| `imageUrls.js`    | `imageUrl`, `normalizeImageUrls`                                                                                   | Build Sanity image URLs to the content-model delivery contract; append `auto=format` to every image URL in a query result, at any depth |

---
description: "Runtime manager — registry and lifecycle manager for background Gel controller instances, handling initialization, arrangement transitions, and teardown."
status: stable
tags:
  - choreography
  - manager

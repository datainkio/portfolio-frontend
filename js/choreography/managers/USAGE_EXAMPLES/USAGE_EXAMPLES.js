...
import ScrollSmootherManager from "/assets/js/choreography/managers/ScrollSmootherManager/ScrollSmootherManager.js";

// Gel manager
import GelAnimationManager from "/assets/js/choreography/managers/GelAnimationManager/GelAnimationManager.js";
...
import {
  ...
  GelAnimationManager,
} from "/assets/js/choreography/managers/index/index.js";
...
const bgLayers = new BackgroundLayerManager([
  "overlay-view",
  "sizzle-background",
]);
bgLayers.fix();
...
const bgLayers2 = new BackgroundLayerManager([
  "overlay-view",
  "sizzle-background",
]);

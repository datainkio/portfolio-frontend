...
export default class CanvasManager {
  ...
  captureOriginalImageData() {
    ...
    offscreenCtx.drawImage(
      ...
      this._image.naturalHeight, // Source dimensions
      0,
      0,
      this._scaledWidth,
      this._scaledHeight, // Destination dimensions
    );

    this._originalImageData = offscreenCtx.getImageData(
      0,
      0,
      this._scaledWidth,
      this._scaledHeight,
  ...
  getOriginalImageData() {
    if (!this._originalImageData) {
      throw new Error(
        "Original image data is not initialized. Call captureOriginalImageData first.",
      );
    }

...
- **`airtable-schema.json`** - Complete Airtable base schema with field types, samples, and relationships (copy for Copilot)
- **`airtable-schema.compact.json`** - Minified version for faster loading
- **`AIRTABLE_SCHEMA.md`** - Human-readable schema documentation

**Note**: The primary schema file is generated at `njk/_data/airtableSchema.json` for 11ty global data access. This directory contains a copy for Copilot context.

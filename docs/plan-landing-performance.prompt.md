...
3. LCP discovery: pick the LCP (hero poster/image or first frame); add `<link rel="preload" as="image" href="...">` in `views/templates/partials/head/head.njk` and remove any lazy attribute on that element.

...
console.log(
  chalk.yellow('npm run setup') + chalk.gray('     - Validate environment & system health')
);
console.log(chalk.yellow('npm start') + chalk.gray('         - Start development server'));

console.log(chalk.green.bold('\n🎨 Design Updates'));
console.log(chalk.yellow('npm run design') + chalk.gray('     - Sync Figma tokens + rebuild CSS'));
...
console.log(chalk.yellow('npm run build') + chalk.gray('       - Production build'));

console.log(chalk.green.bold('\n🔧 Troubleshooting'));
console.log(chalk.yellow('npm run doctor') + chalk.gray('     - System health check'));
console.log(chalk.yellow('npm run help') + chalk.gray('       - View all commands'));
console.log(chalk.yellow('npm run clean') + chalk.gray('      - Clear build directory'));

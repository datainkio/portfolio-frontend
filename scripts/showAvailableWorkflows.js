...
console.log(
  chalk.yellow("  1. npm run validate:env") +
    chalk.gray(" - Check environment setup"),
);
console.log(
  chalk.yellow("  2. npm install") + chalk.gray(" - Install dependencies"),
);
console.log(
  chalk.yellow("  3. npm start") + chalk.gray(" - Start development server"),
);
console.log();

console.log(chalk.green("Working on design updates?"));
console.log(
  chalk.yellow("  1. npm run build:design") +
    chalk.gray(" - Sync Figma tokens"),
);
console.log(
  chalk.yellow("  2. npm run dev:css") + chalk.gray(" - Watch CSS compilation"),
);
console.log();

console.log(chalk.green("Content updates?"));
console.log(
  chalk.yellow("  1. npm run build:11ty") +
...
console.log(
  chalk.yellow("  1. npm run build") + chalk.gray(" - Full production build"),
);
...
console.log(chalk.gray("─".repeat(40)));
console.log(
  chalk.cyan("• npm run build:preview") +
    chalk.gray(" - Detailed build process overview"),
);
console.log(
  chalk.cyan("• npm run test:logger") +
    chalk.gray(" - Verify Logger functionality"),
);
console.log(
  chalk.cyan("• Check README.md") +
    chalk.gray(" - Complete setup documentation"),
);
console.log(
  chalk.cyan("• Review .env.example") +
    chalk.gray(" - Environment variable template"),
);

console.log(chalk.gray("\n" + "─".repeat(60)));
console.log(
  chalk.cyan(
    "💡 Pro tip: Use npm run build:preview:verbose for detailed workflow insights",
  ),
);
console.log();
